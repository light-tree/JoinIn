...
namespace DataAccess.Repositories.Implements
{
    public class ApplicationMajorRepository : IApplicationMajorRepository
    {
        ...
        public List<ApplicationMajor> CreateApplicationMajors(Guid newApplicationId, List<Guid> majorIds)
        {
            List<ApplicationMajor> applicationMajors = new List<ApplicationMajor>();
            foreach (Guid majorId in majorIds)
            {
                applicationMajors.Add(new ApplicationMajor
                {
        ...
        {
            return _context.ApplicationMajors.Where(am => applicationId == am.ApplicationId).ToList();
        }
    }
}
